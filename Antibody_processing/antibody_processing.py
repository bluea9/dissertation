"""
Extracts Fv region from an antibody structure (PDB file) and formats the output 
file for docking with Haddock.

Usage:
    python antibody_processing.py <PDB file> <absolute/path/to/output/directory>

Example:
    python antibody_processing.py HM1.pdb /home/experiment/antibodies/

This script requieres the following tools:
    - ImmunoPDB.py script from ANARCI repository 
    - ab_haddock_format.py from HADDOCK-antibody-antigen repository
    - pdb-tools repository
    - haddock-tools repository

To execute this script, a conda environment with the requierements from the ANARCI 
and HADDOCK-antibody-antigen repository most be activated.
"""
...
parser.add_argument('antibody_prediction', type=str, help='PDB file with antibody structure')
